...
//            System.out.println("result: " + buf.toString().substring(8,24));//16位的加密
    ...
    public static String getSNNum() {
        ...
        try {
            ...
            Method methodGet = c.getMethod("get", String.class);
            sn = (String) methodGet.invoke(c, "ro.serialno");
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     *
     * @param activity          当前页面
     * @param isScreenStayLight 是否常亮
     */
    public static void setIsScreenStayLight(Activity activity, boolean isScreenStayLight) {
        if (activity == null) {
            Timber.e("param error, the activity is null");
            return;
        }
        Window window = activity.getWindow();
        if (isScreenStayLight) {
